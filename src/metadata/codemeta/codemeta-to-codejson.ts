...
export const codemetaToCodeJsonMapping: MappingEntry[] = [
  ...
  { source: "description", target: "description", default: "" },

  { source: "codeRepository", target: "repositoryURL", default: "" },

  { source: "downloadUrl", target: "downloadURL", default: "" },

  { source: "url", target: "homepageURL", default: "" },
  ...
  { source: "keywords", target: "tags", default: [], transform: transformKeywords },

  { source: "dateCreated", target: "date.created", default: "", transform: transformDate },

  { source: "dateModified", target: "date.lastModified", default: "", transform: transformDate },
  ...
  { source: "issueTracker", target: "feedbackMechanism", default: "" },
  ...
  { target: "repositoryVisibility", default: "public" },

  { target: "vcs", default: "git" },

  { target: "laborHours", default: 0 },

  { target: "reuseFrequency", default: {} },

  { target: "maintenance", default: "none" },

  { target: "contractNumber", default: [] },

  { target: "SBOM", default: "None" },

  { target: "AIUseCaseID", default: "0" },
];
