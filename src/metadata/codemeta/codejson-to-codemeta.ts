...
export const codejsonToCodemetaMapping: MappingEntry[] = [
  ...
  { source: "repositoryURL", target: "codeRepository", default: "" },

  { source: "downloadURL", target: "downloadUrl", default: "" },

  { source: "homepageURL", target: "url", default: "" },
  ...
  { source: "tags", target: "keywords", default: [], transform: transformTagsToKeywords },

  { source: "date.created", target: "dateCreated", default: "", transform: stripMidnightUtc },

  { source: "date.lastModified", target: "dateModified", default: "", transform: stripMidnightUtc },

  { source: "feedbackMechanism", target: "issueTracker", default: "" },
  ...
  { target: "@context", default: "https://w3id.org/codemeta/3.0" },

  { target: "@type", default: "SoftwareSourceCode" },
];
